...
本资料由 AI 学组编写，系统梳理了线性代数与解析几何课程的核心内容。涵盖行列式的计算技巧（包括范德蒙行列式、递推法、加边法等）、矩阵运算与性质（乘法、逆矩阵、伴随矩阵、初等变换与秩）、向量与线性方程组解的结构、特征值与特征向量、二次型与正定矩阵，以及空间解析几何中平面与直线方程、向量运算等关键知识点。资料配有典型例题与详细解答，适合期中期末复习使用。

??? note "【AI学组】【线性代数与解析几何】"
    <iframe loading="lazy" src="/static/course/algebra/docs/【AI学组】【线性代数与解析几何】.pdf" type="application/pdf" width=100% height=1000px></iframe>

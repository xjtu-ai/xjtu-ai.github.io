...
## 【AI学组】工科数学分析基础(上)复习资料

本资料由 AI 学组编写，系统梳理了工科数学分析基础（上）的核心内容。涵盖函数与极限（极限求解方法、等价无穷小、连续性）、一元函数微分学（导数与微分、中值定理、泰勒公式、洛必达法则、函数性态分析）、一元函数积分学（不定积分技巧、定积分计算、反常积分）以及常微分方程等章节。资料包含知识点总结、典型例题精讲与解题技巧归纳，适合期末复习与考研备考使用。

??? note "【AI学组】工科数学分析基础(上)复习资料"
    <iframe loading="lazy" src="/static/course/math/docs/【AI学组】工科数学分析基础(上)复习资料.pdf" type="application/pdf" width=100% height=1000px></iframe>

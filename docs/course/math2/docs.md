## 【AI学组】工科数学分析基础（下）复习资料

本资料由 AI 学组编写，系统梳理了工科数学分析基础（下）的核心内容。涵盖多元函数微分学（偏导数与全微分、方向导数与梯度、Taylor 展开、无条件极值与 Lagrange 乘子法、隐函数定理）、多元函数积分学（二重/三重积分的坐标变换与对称性应用、两类曲线/曲面积分、Green/Stokes/Gauss 公式）以及无穷级数（常数项级数审敛、幂级数的收敛域与和函数、Fourier 级数展开）等章节。资料配有丰富的例题解析与解题技巧，适合期末复习使用。

??? note "【AI学组】工科数学分析基础（下）复习资料"
    <iframe loading="lazy" src="/static/course/math2/docs/【AI学组】工科数学分析基础（下）复习资料.pdf" type="application/pdf" width=100% height=1000px></iframe>

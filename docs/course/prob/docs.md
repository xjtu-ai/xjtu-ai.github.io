...
本资料由 AI 学组编写，是概率统计与随机过程课程的期末复习资料。内容涵盖概率论基础（随机事件与概率、条件概率与独立性、随机变量及其分布）、数理统计（参数估计、区间估计、假设检验）、常用分布族（正态分布、χ² 分布、t 分布、F 分布）及其统计量的构造，以及随机过程初步（泊松过程、马尔可夫链）。资料以知识点精讲配合典型例题的形式呈现，帮助把握考试重点。

??? note "【AI学组】概率统计与随机过程复习资料"
    <iframe loading="lazy" src="/static/course/prob/docs/【AI学组】概率统计与随机过程复习资料.pdf" type="application/pdf" width=100% height=1000px></iframe>

## 【AI学组】概率统计与随机过程复习讲座讲义

本讲义是 AI 学组举办的期末复习讲座配套资料。围绕考试高频考点展开，重点讲解参数估计（矩估计与极大似然估计）、区间估计（正态总体均值和方差的置信区间）、假设检验（显著性检验的基本步骤、单/双侧检验、两类错误）以及随机过程的核心概念。讲义结构清晰，配合典型例题逐步讲解，适合在复习后期快速回顾和查漏补缺。

??? note "【AI学组】概率统计与随机过程复习讲座讲义"
    <iframe loading="lazy" src="/static/course/prob/docs/【AI学组】概率统计与随机过程复习讲座讲义.pdf" type="application/pdf" width=100% height=1000px></iframe>

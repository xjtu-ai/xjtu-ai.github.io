...
本资料由 AI 学组编写，系统梳理了计算机程序设计（C++）课程的核心考点。内容涵盖 C++ 基础语法（数据类型、运算符与表达式、控制结构）、数组与指针（数组声明与遍历、指针运算与动态内存分配）、函数（参数传递机制、递归、函数重载）、类与对象（构造函数与析构函数、继承与多态、虚函数、运算符重载）、文件读写与 STL 初步等模块。资料包含知识点总结、常见错误归纳以及典型笔试题解析，适合期中期末笔试复习使用。

??? note "【AI学组】程序设计复习资料"
    <iframe loading="lazy" src="/static/course/program/docs/【AI学组】程序设计复习资料.pdf" type="application/pdf" width=100% height=1000px></iframe>
